...
`Worklog.csv` will act as our work load tracker. I've used the template we decided in the meeting, but split the Date into Day,Month so that we can filter more precisely if required.
...
**IMPORTANT!**
> Please ensure that you surround your description with quotation marks.
