...
/**
 * Test's the least squares algorithm from the CircleSolver
 * @author Adam Miritis
 */
public class LeastSquaresTest
{
    /**
    * Graphs four different circles with Least Squares applied. A manual check is required that a smaller circle is drawn.
     * Status: Passed 4/4 @ 13/9/2016 by Adam Miritis
     **/
   @Test public void leastSquares() throws Exception
    {
